      ...
      <Card className="shadow-card hover:shadow-lg transition-shadow duration-200">
        ...
        <CardContent>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            <Button className="h-20 sm:h-24 flex flex-col gap-2 bg-primary text-primary-foreground hover:bg-primary/90 text-sm transition-all duration-200 touch-manipulation min-h-[60px]">
              <svg className="h-6 w-6 sm:h-7 sm:w-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z" />
              </svg>
              <span className="font-medium text-xs sm:text-sm leading-tight text-center">Manage Users</span>
            </Button>
            
            <Button variant="outline" className="h-20 sm:h-24 flex flex-col gap-2 text-sm hover:bg-accent transition-all duration-200 touch-manipulation min-h-[60px]">
              <svg className="h-6 w-6 sm:h-7 sm:w-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4" />
              </svg>
              <span className="font-medium text-xs sm:text-sm leading-tight text-center">Database Backup</span>
            </Button>
            ...
            <Button variant="outline" className="h-20 sm:h-24 flex flex-col gap-2 text-sm hover:bg-accent transition-all duration-200 touch-manipulation min-h-[60px]">
              ...
              <span className="font-medium text-xs sm:text-sm leading-tight text-center">System Settings</span>
            </Button>
            ...
            <Button variant="outline" className="h-20 sm:h-24 flex flex-col gap-2 text-sm hover:bg-accent transition-all duration-200 touch-manipulation min-h-[60px]">
              ...
              <span className="font-medium text-xs sm:text-sm leading-tight text-center">View Logs</span>
            </Button>
          </div>
        </CardContent>
      </Card>

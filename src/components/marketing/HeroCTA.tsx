    ...
    <div className='p-6 sm:p-10'>
      <div className='inline-block rounded-2xl bg-white/70 backdrop-blur-md px-6 py-5 shadow'>
        ...
        <div className='mt-5 flex flex-wrap gap-3'>
          <Link to='/demo/request' className='inline-flex items-center rounded-xl px-5 py-3 text-white font-semibold shadow transition
                       bg-gradient-to-r from-[#0B1E39] to-[#0F4C81] hover:brightness-110 focus:outline-none focus:ring-2 focus:ring-[#0F4C81]'>
            Request a demo
          </Link>
          <Link to='/auth/signup' className='inline-flex items-center rounded-xl px-5 py-3 font-semibold text-[#0F4C81] bg-white shadow hover:bg-slate-50

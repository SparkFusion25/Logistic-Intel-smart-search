-- Fix bulk import issues by dropping all dependent views

-- 1. Drop all views that depend on unified_shipments columns
DROP VIEW IF EXISTS unified_shipments_enhanced CASCADE;
DROP VIEW IF EXISTS search_companies_view CASCADE; 
DROP VIEW IF EXISTS unified_shipments_view CASCADE;
